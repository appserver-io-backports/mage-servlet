...
/**
 * TechDivision\MageServlet\MageStandardSessionServlet
 *
 * NOTICE OF LICENSE
 *
...
class MageStandardSessionServlet extends HttpServlet
{
     ...
     */
    protected function initSessionGlobals(HttpServletRequest $servletRequest)
    {
        return null;
    }
    ...
    public function prepareResponse(HttpServletRequest $servletRequest, HttpServletResponse $servletResponse)
    {
